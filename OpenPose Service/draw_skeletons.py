...
directory_in_str = r'/home/junia/Dropbox/Junia/PG2/espaço inteligente/tutoriais python/Dataset_MPI'
...
for name in pathlist:
    ...
    output_image = name.replace(".jpg", " - outputMPI.jpg")
    input_image = cv2.imread(name)
    with open(name_json, 'r') as content_file:
        content = content_file.read()
    skeletons = Parse(content, ObjectAnnotations())
    image = draw_skeletons(input_image, skeletons)
